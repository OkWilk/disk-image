...
from src.core.parttable import DiskLayout
...
class DiskDetectTest(unittest.TestCase):
    ...
    @patch('src.core.parttable.logging')
    ...
    @patch('src.core.parttable.Execute')
    ...
    @patch('src.core.parttable.path')
    def test_backup_layout_mbr(self, path_mock):
    ...
    @patch('src.core.parttable.path')
    def test_backup_layout_gpt(self, path_mock):
        path_mock.exists.return_value = True
        self.disk.detect_layout = Mock()
